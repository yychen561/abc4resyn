...
{
int A = Ptr[0];int B = Ptr[1];int C = Ptr[2];
...
{
int A = Ptr[0];int B = Ptr[1];int C = Ptr[2];int D = Ptr[3];
...
{
int A = Ptr[0];int B = Ptr[1];int C = Ptr[2];int D = Ptr[3];int E = Ptr[4];
...
{
int A = Ptr[0];int B = Ptr[1];int CI = Ptr[2];
...
{
int A = Ptr[2];int B = Ptr[0];int C = Ptr[1];
return Mini_AigOr(p, Mini_AigLitNot(C), Mini_AigOr(p, Mini_AigLitNot(B), Mini_AigLitNot(A)));
};
